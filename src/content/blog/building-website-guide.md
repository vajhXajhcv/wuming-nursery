---
title: "从域名到上线：个人网站搭建实战攻略"
description: "适用场景：中国大陆用户，想搭建个人博客/内容站，预算极低（年花费 < 100元），有一定技术学习意愿但非专业开发者。"
pubDate: 2026-05-07
heroImage: ../../assets/blog-covers/building-website-guide.png
tags: ["建站", "教程", "Astro"]
---
...
在 CMD 中执行：
    npx create-astro@latest wuming-nursery
...
解决方案：挂代理后重新执行，或使用 --template 参数直接指定模板：
    npx create-astro@latest wuming-nursery --template blog
...
在项目目录下（cd wuming-nursery）执行：
    git init
    git remote add origin https://github.com/你的用户名/wuming-nursery.git
    git add .
    git commit -m "init: astro blog template"
    git branch -M main
